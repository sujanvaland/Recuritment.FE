...
export default function ContactPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[50vh] w-full bg-black text-white">
        <div className="container flex flex-col items-center justify-center pt-24 pb-16">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6 text-center leading-tight">
            Contact Us
          </h1>
          <p className="mb-8 text-lg md:text-xl text-center text-gray-200 max-w-3xl">
      ...
      <section className="w-full bg-[#eef8f7] py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Quick Support</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {supportOptions.map((option, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow text-center">
                ...
                <Button asChild variant="outline" className="border-[#309689] text-[#309689] hover:bg-[#309689] hover:text-white">
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold mb-6">Send Us a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#309689] focus:border-transparent outline-none transition"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#309689] focus:border-transparent outline-none transition resize-vertical"
                ...
                <Button 
                  ...
                  className="w-full bg-[#309689] hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-lg transition"
                >
                  {isSubmitting ? (
                    "Sending..."
                  ) : (
            ...
            <div>
                ...
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl">
                    <div className="flex-shrink-0">
                      <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#309689] text-white">
                        {info.icon}
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="space-y-1 mb-2">
                        {info.details.map((detail, idx) => (
                          <p key={idx} className="text-[#309689] font-semibold">{detail}</p>
                        ))}
                      </div>
              ...
              {/* Office Hours */}
              <div className="mt-8 p-6 bg-[#309689] text-white rounded-xl">
      ...
      <section className="w-full bg-[#eef8f7] py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          ...
          <div className="text-center mt-12">
            ...
            <Button asChild className="bg-[#309689] hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-lg">
