...
export default function AboutPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[60vh] w-full bg-black text-white">
        <div className="container flex flex-col items-center justify-center pt-24 pb-16">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <Button asChild variant="outline" className="border-white text-white hover:bg-white hover:text-black px-8 py-3 rounded-lg">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="flex justify-center mb-4">
                  <div className="flex items-center justify-center w-16 h-16 rounded-full bg-[#309689] text-white">
                    {stat.icon}
                  </div>
                </div>
                <div className="text-3xl md:text-4xl font-extrabold text-[#309689] mb-2">
                  {stat.number}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex items-start space-x-2 mt-6">
                <CheckCircle className="h-6 w-6 text-[#309689] mt-1" />
                <div>
      ...
      <section className="w-full bg-white py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-[#309689] to-emerald-600 text-white p-8 rounded-2xl">
      ...
      <section className="w-full bg-[#eef8f7] py-16">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Our Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div key={index} className="text-center group">
                ...
                <p className="text-[#309689] font-semibold mb-2">{member.role}</p>
